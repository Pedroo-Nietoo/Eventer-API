...
export class CreateInitialTables1773518528406 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_df5d3d29b591928cede5717aba" ON "events" USING GiST ("location")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_adad8411b9848a0a7e1335944d" ON "ticket_types" ("created_at")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_bd8d0a0f83deecdefbc547d2c1" ON "tickets" ("qr_code")`,
    );
    await queryRunner.query(
