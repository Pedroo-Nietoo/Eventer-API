...
export class StorageService {
 ...
 async generatePresignedUrl(fileName: string, contentType: string, folder: 'users' | 'events') {
  try {
   ...
   throw new InternalServerErrorException('Erro ao gerar URL de upload temporária');
  }
 }
}