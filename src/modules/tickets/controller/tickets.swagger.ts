...
export const SwaggerTicketController = {
  Main: () => applyDecorators(ApiTags('Tickets'), ApiBearerAuth()),
  ...
  Validate: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Valida o JWT do QR Code e marca como USED.',
      }),
      ApiOkResponse({
      ...
      ApiBadRequestResponse({
        description: 'QR Code inválido ou já utilizado/cancelado.',
      }),
  ...
  Update: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Altera status ou troca lote com gestão de estoque.',
      }),
      ApiOkResponse({ type: TicketResponseDto }),
      ApiBadRequestResponse({
        description: 'Estoque insuficiente ou erro na atualização.',
      }),
      ApiNotFoundResponse({
        description: 'Ingresso ou novo lote não encontrado.',
      }),
      ApiUnauthorizedResponse({
        description: 'Acesso negado. Autenticação necessária.',
      }),
  ...
  Delete: () =>
    applyDecorators(
      ApiOperation({
        ...
        description: 'Marca como cancelado e devolve vaga ao estoque.',
      }),
      ApiNoContentResponse({ description: 'Cancelado com sucesso.' }),
      ApiBadRequestResponse({
        description: 'Ingresso já utilizado ou cancelado.',
      }),
      ApiNotFoundResponse({ description: 'Ingresso não encontrado.' }),
      ApiUnauthorizedResponse({
        description: 'Acesso negado. Autenticação necessária.',
